...
//choose ring size
	ring_size_us_can=16;//enter US numerical ring size
...
//choose ring band dimensions
	main_wall=3;//difference between ring inner and outer radius
	main_depth=14;//how wide the band of the ring is
