...
1.1
 ...
 - 	Fixed issue whereby half ellipse was never shown and normal ellipse was shown twice
1.0
...
color(colour_RGBA_metal){
	 translate([(main_internal_diameter)/2, 0, 0]) pill_shape (main_depth, main_wall);
	translate([main_wall+1,0,0])  translate([(main_internal_diameter)/2, 0, 0]) ellipse_shape (main_depth, main_wall);
	translate([2*(main_wall+1),0,0])  translate([(main_internal_diameter)/2, 0, 0]) hemi_ellipse_shape (main_depth, main_wall);

	translate([0,2*main_wall+1,0])  translate([(main_internal_diameter)/2, 0, 0]) rounded_hemi_ellipse_shape (main_depth, main_wall, main_feature);
	translate([main_wall+1,2*main_wall+1,0])  translate([(main_internal_diameter)/2, 0, 0]) rectangle_shape (main_depth, main_wall);
	translate([2*(main_wall+1),2*main_wall+1,0])  translate([(main_internal_diameter)/2, 0, 0]) scallopped_rectangle_shape (main_depth, main_wall, main_feature);

	translate([0,2*(2*main_wall+1),0])  translate([(main_internal_diameter)/2, 0, 0]) rounded_scallopped_rectangle_shape (main_depth, main_wall, main_feature);
	translate([main_wall+1, 2*(2*main_wall+1),0])  translate([(main_internal_diameter)/2, 0, 0]) rounded_rectangle_shape (main_depth, main_wall, main_feature);
	translate([2*(main_wall+1),2*(2*main_wall+1),0])  translate([(main_internal_diameter)/2, 0, 0]) chamfered_rectangle_shape (main_depth, main_wall, main_feature);

	translate([0,3*(2*main_wall+1),0])  translate([(main_internal_diameter)/2, 0, 0]) half_pill_shape (main_depth, main_wall, main_feature);
	translate([main_wall+1,3*(2*main_wall+1),0])  translate([(main_internal_diameter)/2, 0, 0]) translate (v=[main_wall,0,0]) rotate(a=[0,0,180]) hemi_ellipse_shape (main_depth, main_wall);
	translate([2*(main_wall+1),3*(2*main_wall+1),0])  translate([(main_internal_diameter)/2, 0, 0]) translate (v=[main_wall,0,0]) rotate(a=[0,0,180]) rounded_hemi_ellipse_shape (main_depth, main_wall, main_feature);
