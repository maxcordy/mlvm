...
color(colour_RGBA_metal){
	...
	translate([2*(main_internal_diameter+2*main_wall+1),0,0]) rotate_extrude (convexity = 20) translate([(main_internal_diameter)/2, 0, 0]) half_ellipse_shape (main_depth, main_wall);
