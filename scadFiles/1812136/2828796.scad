...
retainer_height = 1; // [0.5:Tiny (0.5mm), 1:Small (1mm), 1.5:Normal (1.5mm), 2:Big (2mm), 3:Bigger (3mm), 4:Hudge (5mm)]

belt_idler = 1; // [0:No, 1:Yes]

// Height of idler flange over pulley. Set to same as base height if you want an idler but no pulley.
idler_height = 1; // [0.5:Tiny (0.5mm), 1:Small (1mm), 1.5:Normal (1.5mm), 2:Big (2mm), 3:Bigger (3mm), 4:Hudge (5mm)]
...
//	translate ([0,0, base_height + toothed_part_length + retainer_height ]) rotate ([0,180,0])
