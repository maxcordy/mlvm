...
//	rotate(90,[0,0,1])
	...
	rotate(90,[0,0,1])
	color("salmon")
//	writesphere(text=text_itself,where=[0,2,0],radius=7,height=10,rotate=0,t=font_thickness,bold=1,h=text_size,font=text_font,space=1.3);
...
difference() {
	...
	translate([11,0,0])rotate ([90,0,0]) scale([2.0,2.2,4.0])sphere(r=4.5,$fn =100);
   }
}