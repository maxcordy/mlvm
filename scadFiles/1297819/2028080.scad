/*
 ...
 Update by Jeff Field January 2016
 Update log:
 November 9th 2014
 ...
 November 28th 2014
		- bug fixes
 January 29th 2016
        - moved hole spacing & size to Advanced to allow customization
        - added able to turn off logo
...
module pin(clip)
{
	...
	if (clip) {
		...
		intersection() {
			...
			translate([0, hole_size/2 + 2.75, board_thickness/2]) 
				rotate([0, 90, 0])
