// Höhe des Schneckenkopfes über dem Teilzylinder
modul=1;
// Anzahl der Gänge (Zähne) der Schnecke
gangzahl=2;
// Länge der Schnecke
laenge=15;
...
eingriffswinkel=20;
// Steigungswinkel der Schnecke, entspricht 90°-Schrägungswinkel. Positiver Steigungswinkel = rechtsdrehend.
steigungswinkel=10;
// Komponenten zusammengebaut für Konstruktion oder auseinander zum 3D-Druck
zusammen_gebaut=0;

/* Bibliothek für Schnecken
...
Ein Eingriffswinkel von 30° erzeugt metrische Schrauben nach DIN 13
