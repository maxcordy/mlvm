...
fin_type = "smooth"; // [trapezoid:Trapezoid, smooth:Smooth, sbend:S-bend]

// Height of fin can
fin_can_height = 90;  // [50 : 200]
...
payload_height = 40; // [10 : 200]

payload_inner_diameter = 22;  // [15: 200]

payload_coupling_height = 25; // [5 : 200]
...
payload_bulkhead = "yes";  // [yes:Yes, no:No]
...
shock_cord_fixing = "no";  // [yes:Yes, no:No]
...
// Wall thickness of the rocket shell/fins in mm - adjust to ensure model is sliced correctly - aim for 2 perimeters in your slicer
perimeter_width = .8;

// Curve precision (number of facets)
curve_precision = 256;  // [6 : 256]
