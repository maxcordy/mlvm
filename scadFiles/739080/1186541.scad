...
block_type = "baseplate"; // [brick:Brick, tile:Tile, wing:Wing, slope:Slope, curve:Curve, baseplate:Baseplate]
...
// If you want a second roadway, how wide should it be (in studs)? A roadway is a smooth (non-studded) section of a baseplate.
roadway_width2 = 8;

// How long should the second roadway be?
roadway_length2 = 20;

// Where should the second roadway start (x-value)? A value of zero puts the roadway at the far left side of the plate.
roadway_x2 = 0;

// Where should the second roadway start (y-value)? A value of zero puts the roadway at the front of the plate.
roadway_y2 = 6;
...
translate([0, 0, (block_type == "tile" ? block_height_ratio * block_height : 0)]) rotate([0, (block_type == "tile" ? 180 : 0), 0]) {
    block(
        ...
        roadway_width=roadway_width,
		  roadway_width2=roadway_width2,
        roadway_length=roadway_length,
		  roadway_length2=roadway_length2,
        roadway_x=roadway_x,
		  roadway_x2=roadway_x2,
        roadway_y=roadway_y,
		  roadway_y2=roadway_y2,
...
module block(
    ...
    real_roadway_width2 = max(0, min(roadway_width2, real_width));
    real_roadway_length2 = max(0, min(roadway_length2, real_length));
    real_roadway_x2 = max(0, min(real_length - real_roadway_length2, roadway_x2));
    real_roadway_y2 = max(0, min(real_width - real_roadway_width2, roadway_y2));
   ...
   translate([-overall_length/2, -overall_width/2, 0]) // Comment to position at 0,0,0 instead of centered on X and Y.
            ...
            if (dual_sided) {
                translate([overall_length/2, overall_width/2, block_height * height]) mirror([0,0,1]) block(
                    ...
                    roadway_width=real_roadway_width,
						  roadway_width2=real_roadway_width2,
						  roadway_length=real_roadway_length,
                    roadway_length2=real_roadway_length2,
                    roadway_x=real_roadway_x,
						  roadway_x2=real_roadway_x2,
                    roadway_y=real_roadway_y,
                    roadway_y2=real_roadway_y2,
                    stud_rescale=stud_rescale,
                    dual_sided=false
                );
            }
    ...
    function pos_in_roadway(x, y) = (
        ...
        && x < real_roadway_x + real_roadway_length
		  ...
		  x >= real_roadway_x2
        && y >= real_roadway_y2
        && y < real_roadway_y2 + real_roadway_width2
        && x < real_roadway_x2 + real_roadway_length2
