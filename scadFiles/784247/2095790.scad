...
//0: Simple(no mounting bracket) - 1: coupling with frame grip - 2: like #1 but with wide hook for balance and no bottom hook
mount = 2;
...
*/				
				if (frameGrip==true) {
					hull() {
						...
						translate([-stepperDistanceM3/2, stepperDistanceM3/2, -1])
						cylinder(r=14/2, h=bodyHeight+2);
					}
				}
			}//union
