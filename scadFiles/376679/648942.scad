...
// First image on top row. Load a 150x150 pixel image.(images will be stretched to fit)  Simple photos work best.  Don't forget to click the Invert Colors checkbox!
image1 = "image-surface.dat"; // [image_surface:150x150]
// Second image on top row.  Don't forget to click the Invert Colors checkbox!
image2 = "image-surface.dat"; // [image_surface:150x150]
// Third image on top row. Don't forget to click the Invert Colors checkbox!
image3 = "image-surface.dat"; // [image_surface:150x150]
// Last image on top row. Don't forget to click the Invert Colors checkbox!
image4 = "image-surface.dat"; // [image_surface:150x150]

/* [Bottom Row Images] */

// First image on bottom row. Don't forget to click the Invert Colors checkbox!
image5 = "image-surface.dat"; // [image_surface:150x150]
// Second image on bottom row. Don't forget to click the Invert Colors checkbox!
image6 = "image-surface.dat"; // [image_surface:150x150]
// Third image on bottom row. Don't forget to click the Invert Colors checkbox!
image7 = "image-surface.dat"; // [image_surface:150x150]
// Last image on bottom row. Don't forget to click the Invert Colors checkbox!
image8 = "image-surface.dat"; // [image_surface:150x150]
