...
CHESTTEXT="";
//Font:
FONT="Letters.dxf"; //[write/Letters.dxf:Basic,write/orbitron.dxf:Futuristic,write/knewave.dxf:Round,write/BlackRose.dxf:Classic,write/braille.dxf:Braille]
...
module text_3d(TEXT="w", TEXT_POSITION=[0,HEIGHT/2.5, THICK]) {
 if (DETAIL_OUTSET > 0) {
