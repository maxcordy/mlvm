...
// v1.1
//
// ADDED second line of text per laird's request.
//
// CHANGED the location of the box lid, this should make it
// easier see where text and images are positioned.
//
// v1.2
//
// CHANGED the scale of the lid by 1.02. Should provide a
// better fit.
//
// v1.3
//
// ADDED the ability to use other Customizer compatible 
// fonts
//
...
// Add a line of text at the top of your box
top_text_label = "";
...
top_text_size = 14; // [1:40]

Move_Top_Text_Up_Down = 60; // [10:65]

top_text_rotation = 0; // [0:None,90:Left,180:Upside Down,270:Right]

// Add a line of text at the bottom of your box
bottom_text_label = "";
...
bottom_text_size = 14; // [1:40]

Move_Bottom_Text_Up_Down = 10; // [10:65]
