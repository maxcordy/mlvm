...
visible = "all" ; // ["all":All objects, "housing":Holder Housing, "socket":Fixation socket, "clip":Fixation clip]

// Fixation concept
Fixation = 2 ; // [0:None, 1:M3 Screws, 2:Servo horn]
...
module keycamhousing()
{
  ...
  // Logo in basement
  translate ([12.7,9,-0.5]) rotate ([0,0,0]) 
       write ("HST", t=0.4, h=5.2, center=true) ;
  translate ([12.9,-9,-0.5]) rotate ([0,0,0]) 
       write ("2015", t=0.4, h=5.2, center=true) ;
}
