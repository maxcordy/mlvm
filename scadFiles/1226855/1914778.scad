...
//1.7oz at 20% Infill & print time of 2:45:14 for 320mm Wing
...
Wing_OD = 220;      //310mm original
                    //If using Outside Ledge, you probably want to add 10mm or more

//2. Diameter of Heat Bed Hole Mounting Pattern
HeatBd_Hole_OD = 210;   //I Rotate 1st Hole 3 degrees From Y-axis to miss side connection

//3. Initial Rotation for Heat Bed Mounting Holes
Hole_InitialRotate = 5;     //Use 3mm for 310 to 320mm Wing_OD, 5mm for 220 Wing_OD
