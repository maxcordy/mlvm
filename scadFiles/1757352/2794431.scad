...
//
// to do:
//   √keep constant angle on cap taper
//   (allow control of taper angle?)
//   √display on build surface w/on-off option
//   √control view
//   √more sanity checks?
//   √possibly angle retaining tabs out a degree or two
//   √adjust tilt on long tabs
//   (allow control of tab angle?)
//   √base tab size on tube size (like 2/3*sqrt((x+y)/2) )
//
//   √adapt to optionally create couplers:
