...
RudderLine=[WaterLine[0]+[0,0,LOA*0.05],WaterLine[0]-[LOA*rnd(0.03,0.07),0,0],BottomLine[0]-[LOA*rnd(0.1,0.15),0,0],KeelLine[0]+[0,0,-LOA*0.01]];
...
extrudeT(SternLine,16,0,1.2){
   ...
   color("RED")hull(){ extrudeT(RudderLine,6,0,1.1){
