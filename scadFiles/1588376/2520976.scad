...
modul = 1;
// Anzahl der Radzähne am Rad
zahnzahl_rad = 32;
// Anzahl der Radzähne am Ritzel
zahnzahl_ritzel = 13;
// Winkel zwischen den Achsen von Rad und Ritzel
achsenwinkel = 90;
// Breite der Zähne von der Außenseite in Richtung Kegelspitze, Standardwert = 90°
zahnbreite = 5;
...
kegelradpaar(modul, zahnzahl_rad, zahnzahl_ritzel, achsenwinkel, zahnbreite, bohrung_rad, bohrung_ritzel, eingriffswinkel, schraegungswinkel, zusammen_gebaut);