...
//Find your Latitude and Longitude at http://universimmedia.pagesperso-orange.fr/geo/loc.htm. Select your latitude range.
...
union(){
  difference()
  {
	...
	difference()
	{
		translate([0,20,0])cylinder(r=70, h=6, $fn=100);
	...
	difference()
	{
		...
		translate([0,20,-1])cylinder(r=50, h=8, $fn=100);
		translate([-40,60,-1])rotate([0,0,-45])cube([120,60,8]);
		translate([-48,-30,-1])rotate([0,0,45])cube([120,65,8]);
	}
