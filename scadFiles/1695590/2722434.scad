...
//Snaphot: 01/09/16
//Added slice option for customizer so you can see what tweaking the parameters does to the fit of the limbs
//Snapshot: 07/08/16
//Added option to add a keyRing hole in the head.
//Added head joint so that head now swivels as well as arms and legs. Same joint adjustment parameters as the shoulders at the moment.
//Dial needle can now be set to random angle by choosing dialAngle=-1
//Snapshot: 28/07/16
//Original upload. Arms and legs move. Tolerances can be adjusted at top of file
...
chestLogo=1; //0 for dial, 1 for BHiveLabs logo
//chestLogo=1;
